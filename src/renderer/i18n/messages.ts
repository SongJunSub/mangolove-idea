...
export const en = {
  ...
  'projectTree.openElsewhere': 'other window',
  'projectTree.openElsewhereTip': 'This repo is open in another window',
  'projectTree.movedToExisting': 'Moved to the existing window',
  'toast.close': 'Close',
  ...
  'projectTree.menu.openHere': 'Open in this window',
  'projectTree.menu.openNewWindow': 'Open in new window',
...
export const ko: Record<MessageKey, string> = {
  ...
  'app.projects': '프로젝트',
  'projectTree.here': '현재',
  'projectTree.openElsewhere': '다른 창',
  'projectTree.openElsewhereTip': '이 저장소는 다른 창에서 열려 있어요',
  'projectTree.movedToExisting': '이미 열린 창으로 이동했어요',
  'toast.close': '닫기',
  ...
  'projectTree.menu.openHere': '이 창에서 열기 (전환)',
  'projectTree.menu.openNewWindow': '새 창에서 열기',
