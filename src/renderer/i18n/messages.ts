...
export const en = {
  ...
  'projectTree.here': 'here',
  'projectTree.loading': 'Loading…',
  'projectTree.error': "Couldn't load worktrees",
  'projectTree.noWorktrees': 'No worktrees',
  'projectTree.empty': 'No repositories yet',
  'projectTree.emptyGroup': 'No repositories in this group',
  'projectTree.newGroupPlaceholder': 'Group name',
  'projectTree.menu.add': 'Add…',
  'projectTree.menu.newGroup': 'New group…',
  'projectTree.menu.newGroupWithRepo': 'New group with this repo…',
  'projectTree.menu.addTo': 'Add to “{name}”',
  'projectTree.menu.removeFromGroup': 'Remove from group',
  'projectTree.menu.rename': 'Rename…',
  'projectTree.menu.ungroup': 'Ungroup',
  'projectTree.menu.forget': 'Remove from list (keeps files)',
  'projectTree.filter.placeholder': 'Filter repos & branches',
  'projectTree.filter.clear': 'Clear filter',
  'projectTree.filter.none': 'No matches',
...
export const ko: Record<MessageKey, string> = {
  ...
  'app.projects': '프로젝트',
  'projectTree.here': '현재',
  'projectTree.loading': '불러오는 중…',
  'projectTree.error': '워크트리를 불러오지 못했어요',
  'projectTree.noWorktrees': '워크트리가 없어요',
  'projectTree.empty': '아직 저장소가 없어요',
  'projectTree.emptyGroup': '이 그룹에 저장소가 없어요',
  'projectTree.newGroupPlaceholder': '그룹 이름',
  'projectTree.menu.add': '추가…',
  'projectTree.menu.newGroup': '새 그룹 만들기…',
  'projectTree.menu.newGroupWithRepo': '이 저장소로 새 그룹 만들기…',
  'projectTree.menu.addTo': '‘{name}’에 담기',
  'projectTree.menu.removeFromGroup': '그룹에서 빼기',
  'projectTree.menu.rename': '이름 바꾸기…',
  'projectTree.menu.ungroup': '그룹 해제',
  'projectTree.menu.forget': '목록에서 지우기 (파일은 그대로)',
  'projectTree.filter.placeholder': '저장소·브랜치 검색',
  'projectTree.filter.clear': '검색 지우기',
  'projectTree.filter.none': '검색 결과가 없어요',
